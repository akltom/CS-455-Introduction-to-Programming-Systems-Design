...
// add private data and methods here
  ...
  ListType * hashTable; // Construct a hash table that contains the pointers to the lists for each bucket.
  
  int findNumNonEmpBuckets() const; // A function that find and return the number of non-empty buckets.
  
  int findLongestChain() const; // A function that find and return the longest chain.
};
