...
public class Concord {
	...
	ArrayList<String> arr = new ArrayList<String>(this.concord.keySet());
    	  Collections.sort(arr, new ConcordComparator(this.concord));
    	 
    	 for (String s : arr)
    	 {
    		 System.out.println(s + " "+ this.concord.get(s));
    	 }
...
class ConcordComparator implements Comparator<String>{
	Map<String, Integer> map;
	public ConcordComparator (Map<String, Integer> map){
		this.map= map;
	}
